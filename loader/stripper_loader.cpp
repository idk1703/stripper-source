...
#define FILENAME_1_6_EP2			PLATFORM_ARCH_FOLDER "stripper.2.ep2" PLATFORM_EXT
#define FILENAME_1_6_EP1			PLATFORM_ARCH_FOLDER "stripper.2.ep1" PLATFORM_EXT
#define FILENAME_1_6_L4D			PLATFORM_ARCH_FOLDER "stripper.2.l4d" PLATFORM_EXT
#define FILENAME_1_6_DARKM			PLATFORM_ARCH_FOLDER "stripper.2.darkm" PLATFORM_EXT
#define FILENAME_1_6_L4D2			PLATFORM_ARCH_FOLDER "stripper.2.l4d2" PLATFORM_EXT
#define FILENAME_1_6_SWARM			PLATFORM_ARCH_FOLDER "stripper.2.swarm" PLATFORM_EXT
#define FILENAME_1_6_BGT			PLATFORM_ARCH_FOLDER "stripper.2.bgt" PLATFORM_EXT
#define FILENAME_1_6_EYE			PLATFORM_ARCH_FOLDER "stripper.2.eye" PLATFORM_EXT
#define FILENAME_1_6_PORTAL2		PLATFORM_ARCH_FOLDER "stripper.2.portal2" PLATFORM_EXT
#define FILENAME_1_6_CSGO			PLATFORM_ARCH_FOLDER "stripper.2.csgo" PLATFORM_EXT
#define FILENAME_1_6_CSS			PLATFORM_ARCH_FOLDER "stripper.2.css" PLATFORM_EXT
#define FILENAME_1_6_HL2DM			PLATFORM_ARCH_FOLDER "stripper.2.hl2dm" PLATFORM_EXT
#define FILENAME_1_6_DODS			PLATFORM_ARCH_FOLDER "stripper.2.dods" PLATFORM_EXT
#define FILENAME_1_6_SDK2013		PLATFORM_ARCH_FOLDER "stripper.2.sdk2013" PLATFORM_EXT
#define FILENAME_1_6_TF2			PLATFORM_ARCH_FOLDER "stripper.2.tf2" PLATFORM_EXT
#define FILENAME_1_6_ND				PLATFORM_ARCH_FOLDER "stripper.2.nd" PLATFORM_EXT
#define FILENAME_1_6_BLADE			PLATFORM_ARCH_FOLDER "stripper.2.blade" PLATFORM_EXT
#define FILENAME_1_6_INSURGENCY		PLATFORM_ARCH_FOLDER "stripper.2.insurgency" PLATFORM_EXT
#define FILENAME_1_6_DOI			PLATFORM_ARCH_FOLDER "stripper.2.doi" PLATFORM_EXT
#define FILENAME_1_6_CONTAGION		PLATFORM_ARCH_FOLDER "stripper.2.contagion" PLATFORM_EXT
#define FILENAME_1_6_BMS			PLATFORM_ARCH_FOLDER "stripper.2.bms" PLATFORM_EXT
#define FILENAME_1_6_MOCK           PLATFORM_ARCH_FOLDER "stripper.2.mock" PLATFORM_EXT
#define FILENAME_1_6_PVKII			PLATFORM_ARCH_FOLDER "stripper.2.pvkii" PLATFORM_EXT
...
DLL_EXPORT METAMOD_PLUGIN *CreateInterface_MMS(const MetamodVersionInfo *mvi, const MetamodLoaderInfo *mli)
{
	...
	char abspath[256];
	UTIL_Format(abspath, sizeof(abspath), "%s" PATH_SEP_STR "%s", mli->pl_path, filename);
